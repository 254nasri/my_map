...
public class clothingsad extends RecyclerView.Adapter<clothingsad.ViewHolder> {
    private Context mcontext;
    Integer counts;
    private List<sellhelper> items;
    public clothingsad(Context context, List<sellhelper> items) {
        this.items=items;
        this.mcontext=context;
    }
    @NonNull
    @Override
    public clothingsad.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mcontext).inflate(R.layout.activity_clothingsad,parent,false);
        return new clothingsad.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull clothingsad.ViewHolder holder, int position) {
